...
public abstract class MessageBody {
  ...
  /**
   * Adds all the MessageTypes provided to a HashSet. Used to decide whether any subsequent message
   * in a thread is considered to be a valid reply to the {@link MessageType} associated to this
   * message body.
   *
   * @param messageTypes - The Message Types that are considered to be valid replies to the {}
   *                     message type
   */
